...
def build(stacked):
  if stacked:
    fig, (axL, axR) = plt.subplots(2, 1, figsize=(9.6, 7.5), dpi=200,
  ...
  name = "fig6_summary_print.png" if stacked else "fig6_summary.png"
...
build(False)      # wide, for slides
build(True)       # stacked, for the printed one-pager
